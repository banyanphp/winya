...
<html lang="en">
    ...
    <!-- Mirrored from colorlib.com/polygon/gentelella/form.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 29 Nov 2016 12:37:44 GMT -->
    <head>
        ...
        <script>
            $(document).ready(function () {
                ...
                $(".select2_multiple").select2({
                    ...
                    placeholder: "With Max Selection limit 12",
                    allowClear: true
                });
            });
        </script>
