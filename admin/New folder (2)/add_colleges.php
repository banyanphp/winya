                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="college_name" name="college_name"  class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                 <div class="form-group">
                     <label class="control-label col-md-3 col-sm-3 col-xs-12" for="country">Country <span class="required">*</span></label>
                      ...
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Founded Year</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="year" class="form-control col-md-7 col-xs-12" type="text" name="year">
                        </div>
                      </div>
                    <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">College Type</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="file" class=" col-md-7 col-xs-12" type="file" name="file">
                        </div>
                      </div>
                  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Intake</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="select2_multiple form-control" id="intake" multiple="multiple" name="name[]">
                      ...
                      <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea class="resizable_textarea form-control" placeholder="Address"></textarea>
                                        </div>
                                    </div>
 <div class="form-group">
...
?>   
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3 pull-right">
                          ...
                          <button type="button" id="add_colleges" class="btn btn-success">Submit</button>
                        </div>
                      </div>
