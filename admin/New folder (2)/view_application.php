                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <?php
                                    $id = $_GET['id'];
                                    $fetch_application = mysqli_fetch_array(mysqli_query($bd,"select * from application where status='1' and application_id=$id"));
                                        ...
                                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="#" method="post">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    <input type="text" id="applicant" class="form-control" disabled="disabled" placeholder="Disabled Input" value="<?php echo $fetch_user['name']; ?>" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <?php
                                            $fetch_query1 = mysqli_query($bd,"select * from process_table where application_id=$id and is_completed=1");
                                            ...
                                            while ($fetch_timeline1 = mysqli_fetch_array($fetch_query1)) {
                                                ...
                                                while ($fetch_data = mysqli_fetch_array($fetch_query2)) {
                                                  ...
                                                  <div class="form-group" id="grid_GridHeader">
                                                        ...
                                                        <input type="checkbox"  class="flat" checked="checked" disabled="disabled" id="timelines" value="<?php echo $ids ?>" class="input-assumpte">&nbsp;Completed
                                            ...
                                            ?> 
<?php   $q1=mysqli_query($bd,"select * from timeline where status='1' and country_id=$country_id and college_id=$college_id and course_id=$course_id ");
$timeline_count=  mysqli_num_rows($q1);

 $q2=mysqli_query($bd,"select * from process_table where application_id=$id and is_completed=1");
$process_table_count=  mysqli_num_rows($q2);
if($process_table_count!=$timeline_count){
?>
                                            <div class="form-group" id="grid_GridHeader">                   
                                                <?php
                                                $fetch_query1 = mysqli_query($bd,"select * from process_table where application_id=$id  and is_completed=0");
       ...
       <input type="checkbox" name="timeline_id" style="width:20px;height:20px"  id="timeline" value="<?php echo $fetch_data['timeline_id'] ?>" class="input-assumpte"> &nbsp;<span>Completed</span>
                                                ...
                                                <?php } ?>
                                                <span id="expecteddate" style="float:right"></span>    
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3 pull-right">
                                                    ...
                                                    <input type="hidden" value="<?php echo $id ?>" name="applicant_id" id="applicant_id">
                                                    <?php
                                                    $count = count($ids2);
                                                    for ($i = 0; $i < $count; $i++) {
                                                        ?>      
