                                        ...
                                        <form id="add_college" action="store.php?action=add_courses" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" id="coursename" class="form-control col-md-7 col-xs-12" name="coursenames" required>
                                                </div>
                                            </div>
 <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12"> Course Short Name <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" id="courseshortnames" class="form-control col-md-7 col-xs-12" name="courseshortnames" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div id="parttime" style="display: none">
                                                <div class="form-group" >
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" class="form-control" id="part_duration" name="part_duration" required>  
                                                    </div>
                                                </div>
                                                <div class="form-group" >
                                            ...
                                            <div id="fulltime" style="display: none">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" class="form-control" id="full_duration" name="full_duration" required> 
                                                    </div>
                                                </div>
                                                <div class="form-group" >
