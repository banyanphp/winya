                                        ...
                                        <form id="add_timeline" action='store.php?action=timelineadd' method='post' data-parsley-validate  class="form-horizontal form-label-left">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select class="form-control" id="country" name="country" onchange="getNewVals(this.value);" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select class="form-control" id="college_name" name="college_names"  onchange="getNewVal(this.value);">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select id="app_course" class="form-control" name="app_course">
