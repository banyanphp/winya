...
<html lang="en">
  ...
  <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="country">Select Branch <span class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select class="form-control" id="branch_name" name="branch_name">

                                                        <option value="0">Choose Branch</option>
                                                        <?php
                                                        $fetch_query = mysqli_query($bd, "select * from tbl_branch where branch_status='1'");
                                                        while ($fetch_country = mysqli_fetch_array($fetch_query)) {
                                                            ?>

                                                            <option value="<?php echo $fetch_country['branch_id'] ?>"><?php echo $fetch_country['branch_name'] ?></option>
<?php } ?>
                                                    </select>
                                                </div>
                                            </div>
...
<?php include 'footer.php'; ?>
        ...
        <script src="vendors/branchamount/addamount.js"></script>
