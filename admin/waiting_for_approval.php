                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        ...
                                        echo $fetch_admin['branch_name'];?> Branch(Waiting for approval)</h2>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="x_content">
                                        ...
                                        <table  class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                $admin_query = mysqli_query($bd, "SELECT * FROM `tbl_balance_sheet` WHERE `branch_id`='$branch_id' and `balance_sheet_status`='0'" );
