                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        ...
                                        <h2><?php
$admin_query = mysqli_query($bd, "SELECT * FROM `tbl_branch`");
$sno = 1;
$total = "0";
...
?> Waiting for approval</h2>
                                    ...
                                    <div class="x_content">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered">                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Date</th>
                                            ...
                                            <tbody>
<?php
$admin_query = mysqli_query($bd, "SELECT * FROM `tbl_balance_sheet` WHERE `balance_sheet_status`='0'");
$sno = 1;
$total = "0";
$totals = "0";
while ($fetch_admin = mysqli_fetch_array($admin_query)) {
    $bills = $fetch_admin['bills'];
    $balance_sheet_id = $fetch_admin['balance_sheet_id'];
    ?>
                                                    <tr>
                                                        <td><?php echo $sno++ ?></td>
                                                        ...
                                                        <td><?php
                                                $totals+= $fetch_admin['balance_sheet_debit'];
                                                echo $debit = $fetch_admin['balance_sheet_debit'];
                                                if ($debit != '') {
        ?>    
                                                               ...
                                                               ?></td>
                                                        <td>                                                            <button type="button" class="btn btn-primary" onclick="approval(<?php echo $balance_sheet_id; ?>)"><i class="fa fa-check"></i></button>
                                                        </td>
