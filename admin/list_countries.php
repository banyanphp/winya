...
<html lang="en">
    ...
    <body class="nav-md">
                            ...
                            <div role="document" class="modal-dialog" >
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="add_countries" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                                            ...
                                            <div class="pull-right">
                                                <button id="gzfg" class="btn btn-success">Submit</button>
                                                ...
                                                while ($fetch_country = mysqli_fetch_array($country_query)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button type="button" class="btn btn-danger" onclick="deletecountry(<?php echo $id; ?>)"><i class="fa fa-trash"></i></button>
                                                        </td>
        ...
        <script src="vendors/countries/add.js"></script>
