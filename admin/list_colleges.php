         ...
         <?php
                                    if (isset($_SESSION["msg"])) {
                                     ...
                                     if (isset($_SESSION["updatemsg"])) {
                                        ...
                                        <?php } else if ($_SESSION["updatemsg"] == "N") {
                                            unset($_SESSION['updatemsg']);
                                            ?>
                                            <div class="alert alert-danger fade in m-b-15">
                                                <strong>Error!</strong>
                                    ...
                                    <div class="x_content">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                $college_query = mysqli_query($bd, "select * from college where status='1'");
                                                $sno = 1;
                                                while ($fetch_college = mysqli_fetch_array($college_query)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $fetch_college['founded_year']; ?></td>
                                                        <!--<td><img src="images/country/<?php echo $fetch_country['flag']; ?>" class="img-responsive" style="width: 40px;"></td>-->

                                                        <td>
                                                            <button type="button" class="btn btn-success" onclick="window.location.href = 'update_college.php?id=<?php echo $id; ?>'"><i class="fa fa-eye"></i></button>
