...
$id = $_REQUEST['id'];
$college_query = mysqli_query($bd, "select * from college where status='1' and college_id='$id'");
$sno = 1;
while ($fetch_college = mysqli_fetch_array($college_query)) {
    $id = $fetch_college['college_id'];
    $country_id = $fetch_college['country_id'];
    $college_name = $fetch_college['college_name'];
    $country_id = $fetch_college['country_id'];
    $founded_year = $fetch_college['founded_year'];
    $college_intake = $fetch_college['intake'];
    $college_intake_explode = explode(",", $college_intake);
    $college_intake_explode_count = count($college_intake_explode);
    $college_address = $fetch_college['college_address'];
    $college_details = $fetch_college['college_details'];
    $college_type = $fetch_college['type'];
    $college_url = $fetch_college['college_website'];
}
?>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        <br />
                                        <form id="add_college" method="POST" action="store.php?action=update_college" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                                            <input type="hidden" value="<?php echo $id ?>" name="clg_id">

                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12">College/University Name <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="text" id="college_name" name="college_names"  value="<?php echo $college_name ?>" required class="form-control col-md-7 col-xs-12">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="year" class="form-control col-md-7 col-xs-12" value="<?php echo $founded_year ?>" required type="text" name="year"  onKeyPress="return isNumberKey(event)" maxlength="4">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">College Type <span class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="type" class="form-control col-md-7 col-xs-12" value="<?php echo $college_type ?>" required type="text" name="type" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Website <span class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="url" class="form-control col-md-7 col-xs-12" value="<?php echo $college_url; ?>" required type="url" name="url">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <select class="select2_multiple form-control" required id="intake" multiple="multiple" name="name[]">
                                                        ...
                                                        while ($row = mysqli_fetch_array($intake_query)) {
                                                            ...
                                                            <?php
                                                            for ($i = 0; $i < $college_intake_explode_count; $i++) {
                                                                $college_intake_explodes = $college_intake_explode[$i];
                                                                if ($college_intake_explodes == $sname) {
                                                                    echo "selected";
                                                                }
                                                            }
                                                            ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <textarea id="clg_addr" required name="clg_addr" class="resizable_textarea form-control" placeholder="Address"><?php echo $college_address ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
...
// $oFCKeditor->BasePath = '/fckeditor/' ;	// '/fckeditor/' is the default value.
                                                    ...
                                                    $oFCKeditor->Value = $college_details;
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3 pull-right">
                                                    ...
                                                    <button id="add_colleges"  type="submit" class="btn btn-success">Submit</button>
                                                </div>
                                            </div>
