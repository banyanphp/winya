...
<link rel="shortcut icon" href="images/img.jpg">
        ...
        <div class="container body">
            <div class="main_container">
				...
				<table id="datatable-buttons" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                $app_query = mysqli_query($bd,"select * from tbl_application where application_process_status='Completed'");
  ...
  $fetch_college= mysqli_fetch_array(mysqli_query($bd, "select * from college where college_id='$applicant_univrcty'"));

													$applicant_pay = $fetch_application['applicant_paymnt'];
													$applicant_brch = $fetch_application['applicat_branch_id'];
                                                      $fetch_branch = mysqli_fetch_array(mysqli_query($bd, "select * from tbl_branch where branch_id='$applicant_brch'"));
$applicant_brch_name=$fetch_branch['branch_name'];
													$applicant_dat = $fetch_application['applicant_createdon'];
                                                    $applicant_dat =date('Y-m-d',strtotime($applicant_dat));
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $sno++ ?></td>
                                                        <td><?php echo $applicant_name, $applicant_name2;?></td>
                                                        <td><?php echo $Applicant_mail; ?></td>
                                                        <td><?php echo $fetch_college['college_name'];; ?></td>
                                                        <td><?php echo $applicant_pay; ?></td>
                                                        <td><?php echo $applicant_brch_name; ?></td>
