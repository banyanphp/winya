        ...
        ?>
                                ...
                                ?>
                                        <table id="datatable-buttons" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                $timeline_query = mysqli_query($bd,"select COUNT(timeline_id) as time,country_id,college_id,course_id,timeline_id from timeline where status='1' group by college_id,course_id,country_id");
                                              //  $count=  mysql_query("select COUNT(timeline_id) as time from timeline where status='1' group by college_id,course_id,country_id");
                                                $sno = 1;
                                                while ($fetch_timeline = mysqli_fetch_array($timeline_query)) {
